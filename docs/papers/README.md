...
- **File:** [`cross-domain-techniques.pdf`](cross-domain-techniques.pdf)
...
Refresh the PDF (only when a new version ships on Zenodo):
...
The PDF is committed to the repo once per published version; it is not auto-downloaded in CI.
